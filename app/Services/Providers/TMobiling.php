...
class TMobiling implements ProviderInterface
{
    ...
    public static function catalog(): array
    {
        ...
        return [
            ...
            self::row('11', 'LESI Pay', 'broadband', 'broadband', null, 'lesi-pay'),
            ...
            self::row('40', 'Uber Lanka', 'wallet', 'wallet-topup', 'assets/logos/ubereats.png', 'uber'),
            self::row('41', 'Tripmo', 'wallet', 'wallet-topup', null, 'tripmo'),
            self::row('25', 'EzCash Send', 'wallet', 'wallet-topup', null, 'ezcash-send'),
            self::row('27', 'EzCash Withdraw', 'wallet', 'wallet-topup', null, 'ezcash-withdraw'),
            ...
            self::row('33', 'HNB Finance', 'insurance', 'insurance', 'assets/logos/hnbassu.png', 'hnb-finance', true),
            self::row('34', 'Janashakthi Life', 'insurance', 'insurance', null, 'janashakthi', true),
            self::row('35', 'Allianz Life', 'insurance', 'insurance', null, 'allianz', true),
            self::row('36', 'Sri Lanka Insurance', 'insurance', 'insurance', 'assets/logos/srilankains.png', 'sli', true),
            self::row('37', 'Union Assurance Life', 'insurance', 'insurance', null, 'union-assurance', true),
            self::row('38', 'Softlogic Life', 'insurance', 'insurance', null, 'softlogic-life', true),
            self::row('39', 'VisionFund Lanka', 'insurance', 'insurance', null, 'visionfund', true),
            self::row('68', 'HNB Assurance', 'insurance', 'insurance', 'assets/logos/hnbassu.png', 'hnb-assurance', true),
            self::row('80', 'Fintrex Finance', 'insurance', 'insurance', null, 'fintrex', true),
